    ...
    <div className="grid min-h-screen place-items-center bg-[#f7f9ff] p-6">
      <div className="w-full max-w-md">
        ...
        <div className="mt-8 rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Enter your work email and we'll send a reset link.</p>
          <form
          ...
          <p className="mt-4 text-xs text-muted-foreground">
            Remembered? <Link to="/login" className="text-foreground hover:underline">Back to sign in</Link>
          </p>
        </div>
      </div>
    </div>
