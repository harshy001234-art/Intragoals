      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-5 py-16 md:grid-cols-2">
        <div>
          ...
          <h1 className="display-font mt-3 text-4xl text-[color:var(--brand-ink)] md:text-6xl">
            Talk to the Intragoals team
          </h1>
          <p className="mt-4 text-lg leading-8 text-muted-foreground">
            Tell us about your cycle, your team size, and what you're trying to fix. We typically
            reply within one business day.
          </p>
          <div className="mt-8 space-y-3 text-sm">
            <div>
              <span className="text-muted-foreground">Sales: </span>sales@intragoals.com
            </div>
            <div>
              <span className="text-muted-foreground">Support: </span>support@intragoals.com
            </div>
            <div>
              <span className="text-muted-foreground">Privacy: </span>privacy@intragoals.com
            </div>
          </div>
        </div>
        <form
